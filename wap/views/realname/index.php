...
<div class="invest-regissfrz-likeapp">
       ...
       <div class="regis-two">
                ...
                <input type="text" placeholder="输入您的姓名" class="form-control put-1" name="username"/>
       </div>
       <div class="regis-three"></div>
       <div class="regis-four">
       			<img src="/static/images/app-sfzh.png" class="reg-2"/>
                <input type="text" placeholder="输入您的身份证号" class="form-control put-2" name="card_id"/>
      		
       </div>
       <div class="regis-five">
       					
                        <button id="gorealname">开通易宝</button>
                        <ul>
                        		<li>温馨提示：</li>
...
<script type="text/javascript">
    diyou.use('wap_realname', function(wap) {
        wap.gorealname();
        wap.closedtishi();
    });
</script>
